...
2. Yakovenko /et a/ (2014) suggest the outbreak stemmed from a single
   ...
   pre-present.*
3. Li /et al/ (2017) use a fixed mean latency period of 4 days and an
   estimated mean infectious period with a prior distribution of
   \(\Gamma(5.12, 1.7)\) (which has an mean of \(\approx 3.0\)).
4. A very rough estimate of the detection probability is 1 in 200. If
...
5. The date of the first round of vaccination occured 61 days prior to
...
7. Because it seems likely that there was effort to sequence the first
